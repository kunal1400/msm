...
<p>
	<label for="<?php echo $this->get_field_id( 'template' ); ?>"><?php _e( 'Select Template', 'advanced-classifieds-and-directory-pro' ); ?></label> 
	<select class="widefat" id="<?php echo $this->get_field_id( 'template' ); ?>" name="<?php echo $this->get_field_name( 'template' ); ?>">
    	<option value="list" <?php selected( $instance['template'], 'list' ); ?>><?php _e( 'List', 'advanced-classifieds-and-directory-pro' ); ?></option>
        <option value="dropdown" <?php selected( $instance['template'], 'dropdown' ); ?>><?php _e( 'Dropdown', 'advanced-classifieds-and-directory-pro' ); ?></option>
    </select>
</p>
