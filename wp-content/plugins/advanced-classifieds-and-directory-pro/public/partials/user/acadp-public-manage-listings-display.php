            ...
            <div class="col-md-3 text-right">
                ...
                <div class="btn-group btn-group-justified">
                    ...
                    <?php endif; ?>
               		...
               		<a href="<?php echo acadp_get_listing_delete_page_link( $post->ID ); ?>" class="btn btn-danger btn-sm" onclick="return confirm( '<?php _e( 'Are you sure you want to delete this listing?', 'advanced-classifieds-and-directory-pro' ); ?>' );">
