...
class ACADP {
	...
	private function load_dependencies() {
		...
		require_once ACADP_PLUGIN_DIR . 'admin/class-acadp-admin-welcome.php';
	...
	private function define_admin_hooks() {
		...
		// Hooks specific to the 'welcome' page of the plugin
		$plugin_admin_welcome = new ACADP_Admin_Welcome();
		
		$this->loader->add_action( 'admin_menu', $plugin_admin_welcome, 'add_welcome_page_menu' );
