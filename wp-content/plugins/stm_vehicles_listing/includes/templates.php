...
function stm_listings_load_results($source = null, $type = null)
{
	$GLOBALS['wp_query'] = stm_listings_query($source = null);
	stm_listings_load_template('filter/results',['type' => $type]);
	wp_reset_query();
}
