...
function stm_save_genuine_price( $post_id ) {
    ...
    if(isset($_POST['butterbean_stm_car_manager_setting_price']) || isset($_POST['butterbean_stm_car_manager_setting_sale_price'])) {
        $price = (isset($_POST['butterbean_stm_car_manager_setting_price'])) ? $_POST['butterbean_stm_car_manager_setting_price'] : $_POST['butterbean_stm_car_manager_setting_sale_price'];
    }
