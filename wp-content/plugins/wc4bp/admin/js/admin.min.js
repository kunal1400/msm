...
return{init:function(){jQuery(function(){jQuery("#tabs").tabs()});var e=jQuery("#continue_update_paged");0<e.length&&e.click(s);var t=jQuery(".wc_bp_sync_all_user_data");0<t.length&&t.click(u)

/* Premium Code Stripped by Freemius */
}}}var wc4bpImplementation=wc4bpAdministration();jQuery(document).ready(function(){wc4bpImplementation.init()});